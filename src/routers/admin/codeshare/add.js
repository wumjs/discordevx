...
app.post("/admin/addcode", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(global.config.server.channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://discordevs.xyz/user/${req.user.id})** added the code named **${rBody['codename']}** to the system.`)
        .addField("Code Link", `https://discordevs.xyz/code/${kod}`, true)
