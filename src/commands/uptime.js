...
var bot = message.mentions.users.first()
    ...
    if(!bot)
    {
      ...
      .setDescription(`<:emoji_74:936700721166962708> *Thats not a current bot in DiscorDev or in guild.*`)
       .setColor("#7289da")
