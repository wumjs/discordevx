...
module.exports.run = async (client, message, args) => {
  ...
  if (!bot) {
      ...
      .setDescription(`<:emoji_74:936700721166962708> *You have given an invalid bot ID or mention.*\n<:emojiArr:936700599121088522> **Ex.** *-votebot @bot or 123456789123456789*`)
       .setColor("#7289da")
  ...
  var seconds = timeleft.seconds;
    ...
    let web = new MessageButton()
      ...
      .setStyle("url")
      .setURL("https://discordevs.xyz/bot/"+botdata.botID)
    const vote = new Discord.MessageEmbed()
    .setTitle("Voted")
    .setColor("GREEN")
    .setAuthor(message.author.username, message.author.avatarURL({ dynamic: true }))
    .setDescription(`You have successfully voted for bot **${botdata.username}**.`)
    .setImage('https://cdn.discordapp.com/attachments/935983051136184382/944602279833649173/PicsArt_02-19-05.32.07.jpg')
  ...
  if (botdata.dcwebhook) {
    ...
    const msg = new webhook.MessageBuilder()
      .setName("DiscorDev Bot List Discord Webhooks")
